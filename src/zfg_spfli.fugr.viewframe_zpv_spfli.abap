*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZPV_SPFLI
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZPV_SPFLI           .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZPV_SPFLI'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZPV_SPFLI_EXTRACT
TOTAL = ZPV_SPFLI_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZPV_SPFLI'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZPV_SPFLI-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZPV_SPFLI_EXTRACT
TOTAL = ZPV_SPFLI_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZPV_SPFLI-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZPV_SPFLI'
...
TOTAL = ZPV_SPFLI_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZPV_SPFLI-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZPV_SPFLI-UPD_FLAG NE SPACE.
